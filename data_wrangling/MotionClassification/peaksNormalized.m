...
data = load('normalNormalized.csv'); %import dataset
data2 = load('ascentNormalized.csv'); %import dataset
...
%}
figure;
findpeaks(AX,time,'MinPeakProminence',1,'Annotate','extents')
title('test')
...
%{
hold on
findpeaks(AX2,Fs,'MinPeakHeight',1.2);
title('AX Normalized Peaks')
